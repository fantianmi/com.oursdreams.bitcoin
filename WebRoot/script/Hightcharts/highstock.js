...
(function() {
    ...
    function I(a, b, c) {
        ...
        else if (r(b) && ba(b)) for (d in b) a.setAttribute(d, b[d]);
        return e
    }
    function ia(a) {
        return Qa(a) ? a: [a]
    ...
    function J(a, b) {
        if (Ha && !$ && b && b.opacity !== s) b.filter = "alpha(opacity=" + b.opacity * 100 + ")";
        u(a.style, b)
    }
    ...
    function Ja(a, b) {
        ...
        e, f, g, h, i, k = []; (c = a.indexOf(c)) !== -1;) {
            ...
            if (d) {
                ...
                h = G.lang,
                i = void 0,
                /f$/.test(f) ? (i = (i = f.match(g)) ? i[1] : -1, e = Ia(e, i, h.decimalPoint, f.indexOf(",") > -1 ? h.thousandsSep: "")) : e = ra(f, e)
            }
            k.push(e);
            a = a.slice(c + 1);
            c = (d = !d) ? "}": "{"
    ...
    Rb = U.opera,
    Ha = /msie/i.test(Da) && !Rb,
    lb = C.documentMode === 8,
    mb = /AppleWebKit/.test(Da),
    ab = /Firefox/.test(Da),
    db = /(Mobile|Android|Windows Phone)/.test(Da),
    Na = "http://www.w3.org/2000/svg",
    $ = !!C.createElementNS && !!C.createElementNS(Na, "svg").createSVGRect,
    Yb = ab && parseInt(Da.split("Firefox/")[1], 10) < 4,
    ga = !$ && !Ha && !!C.createElement("canvas").getContext,
    Xa,
    bb,
    Sb = {},
    Ab = 0,
    ...
    Pb,
    H = {},
    Q = U.Highcharts = U.Highcharts ? na(16, !0) : {};
    ra = function(a, b, c) {
    ...
    Bb = {
        ...
        U.HighchartsAdapter = U.HighchartsAdapter || a && {
            init: function(b) {
                ...
                function(a, b) {
                    ...
                    b === "cur" ? e = c.prototype: b === "_default" && f && (e = g[b], b = "set"); (j = e[b]) && (e[b] = function(c) {
                        ...
                        d.attr ? d.attr(c.prop, b === "cur" ? s: c.now) : j.apply(this, arguments)
                    })
                });
                R(e, "get",
                function(a, b, c) {
            ...
            fireEvent: function(b, c, d, e) {
                var f = a.Event(c),
                g = "detached" + c,
                h; ! Ha && d && (delete d.layerX, delete d.layerY);
                u(f, d);
    ...
    G = {
        colors: "#f01717,#0d233a,#8bbc21,#910000,#1aadce,#492970,#f28f43,#77a1e5,#c42525,#a6c96a".split(","),
    ...
    Ea = function(a) {
        ...
        c,
        d; (function(a) {
            a && a.stops ? d = va(a.stops,
            function(a) {
                return Ea(a[1])
            }) : (c = cc.exec(a)) ? b = [y(c[1]), y(c[2]), y(c[3]), parseFloat(c[4], 10)] : (c = dc.exec(a)) ? b = [y(c[1], 16), y(c[2], 16), y(c[3], 16), 1] : (c = ec.exec(a)) && (b = [y(c[1]), y(c[2]), y(c[3]), 1])
        })(a);
        return {
            get: function(c) {
                var f;
    ...
    Ca.prototype = {
        ...
        attr: function(a, b) {
            ...
            p = I(g, c) || this[c] || 0,
            c !== "d" && c !== "visibility" && c !== "fill" && (p = parseFloat(p));
            else {
                for (c in a) if (k = !1, d = a[c], e = j[c] && j[c].call(this, d, c), e !== !1) {
                    ...
                    else if (h === "rect" && c === "r") I(g, {
                        rx: d,
                        ry: d
                    }),
                    k = !0;
                    else if (c === "translateX" || c === "translateY" || c === "rotation" || c === "verticalAlign" || c === "scaleX" || c === "scaleY") k = o = !0;
                    else if (c === "stroke") d = i.color(d, g, c);
                    else if (c === "dashstyle") if (c = "stroke-dasharray", d = d && d.toLowerCase(), d === "solid") d = X;
                    else {
                        if (d) {
                            ...
                            for (e = d.length; e--;) d[e] = y(d[e]) * n(a["stroke-width"], this["stroke-width"]);
                            d = d.join(",")
                        }
                    ...
                    e || (e = C.createElementNS(Na, "title"), g.appendChild(e)),
                    e.textContent = d;
                    c === "strokeWidth" && (c = "stroke-width");
                    if (c === "stroke-width" || c === "stroke") {
                        this[c] = d;
                        if (this.stroke && this["stroke-width"]) I(g, "stroke", this.stroke),
                        I(g, "stroke-width", this["stroke-width"]),
                        this.hasStroke = !0;
                    ...
                    if (l && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(c)) for (e = l.length; e--;) I(l[e], c, c === "height" ? v(d - (l[e].cutHeight || 0), 0) : d);
                    if ((c === "width" || c === "height") && h === "rect" && d < 0) d = 0;
                    this[c] = d;
                    if (c === "text") {
                        if (d !== this.textStr) delete this.bBox,
                        this.textStr = d,
        ...
        clip: function(a) {
            return this.attr("clip-path", a ? "url(" + this.renderer.url + "#" + a.id + ")": X)
        },
        crisp: function(a) {
            var b, c = {},
        ...
        updateTransform: function() {
            ...
            a = ["translate(" + a + "," + b + ")"];
            e ? a.push("rotate(90) scale(-1,1)") : f && a.push("rotate(" + f + " " + (this.x || 0) + " " + (this.y || 0) + ")"); (r(c) || r(d)) && a.push("scale(" + n(c, 1) + " " + n(d, 1) + ")");
        ...
        align: function(a, b, c) {
            ...
            f = e.alignedObjects;
            if (a) {
                if (this.alignOptions = a, this.alignByTranslate = b, !c || ka(c)) this.alignTo = d = c || "renderer",
                ma(f, this),
                f.push(this),
                c = null
        ...
        getBBox: function() {
            ...
            d = this.textStr;
            var h;
            if (d === "" || Zb.test(d)) h = d.toString().length + (f ? "|" + f.fontSize + "|" + f.fontFamily: ""),
            a = b.cache[h];
            if (!a) {
                ...
                if (b.isSVG) {
                    ...
                    if (e) a.width = O(d * fa(g)) + O(c * aa(g)),
                    a.height = O(d * aa(g)) + O(c * fa(g))
                }
                this.bBox = a;
                h && (b.cache[h] = a)
            }
        ...
        add: function(a) {
            ...
            if (c.handleZ) {
                a = d.childNodes;
                for (g = 0; g < a.length; g++) if (b = a[g], c = I(b, "zIndex"), b !== e && (y(c) > f || !r(f) && r(c))) {
                    d.insertBefore(e, b);
                    h = !0;
                    break
                }
        ...
        shadow: function(a, b, c) {
            ...
            if (a) {
                i = n(a.width, 3);
                k = (a.opacity || 0.15) / i;
                j = this.parentInverted ? "(-1,-1)": "(" + n(a.offsetX, 1) + ", " + n(a.offsetY, 1) + ")";
                for (e = 1; e <= i; e++) {
                    f = g.cloneNode(0);
                    h = i * 2 + 1 - 2 * e;
                    I(f, {
                    ...
                    if (c) I(f, "height", v(I(f, "height") - h, 0)),
                    f.cutHeight = h;
    ...
    ha.prototype = {
        ...
        init: function(a, b, c, d, e) {
            ...
            this.setSize(b, c, !1);
            var h;
            if (ab && a.getBoundingClientRect) this.subPixelFix = b = function() {
                J(a, {
                    left: 0,
                    top: 0
                });
        ...
        buildText: function(a) {
            ...
            c = this,
            d = c.forExport,
            e = n(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), f = b.childNodes, g = /<.*style="([^"]+)".*>/, h = /<.*href="(http[^"]+)".*>/, i = I(b, "x"), k = a.styles, j = a.textWidth, l = k && k.lineHeight, m = f.length, o = function(a) {
            ...
            function(e, f) {
                ...
                function(e) {
                    if (e !== "" || l.length === 1) {
                        var p = {},
                        n = C.createElementNS(Na, "tspan"),
                        q;
                        g.test(e) && (q = e.match(g)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), I(n, "style", q));
                        h.test(e) && !d && (I(n, "onclick", 'location.href="' + e.match(h)[1] + '"'), J(n, {
                            cursor: "pointer"
                        }));
                        e = (e.replace(/<(.|\n)*?>/g, "") || " ").replace(/&lt;/g, "<").replace(/&gt;/g, ">");
                        if (e !== " " && (n.appendChild(C.createTextNode(e)), m ? p.dx = 0 : p.x = i, I(n, p), !m && f && (!$ && d && J(n, {
                            display: "block"
                        }), I(n, "dy", o(n), mb && n.offsetHeight)), b.appendChild(n), m++, j)) for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), p = e.length > 1 && k.whiteSpace !== "nowrap", s, r, t = a._clipHeight, E = [], v = o(), u = 1; p && (e.length || E.length);) delete a.bBox,
                        s = a.getBBox(),
                        r = s.width,
                        !$ && c.forExport && (r = c.measureSpanWidth(n.firstChild.data, a.styles)),
                        s = r > j,
                        !s || e.length === 1 ? (e = E, E = [], e.length && (u++, t && u * v > t ? (e = ["..."], a.attr("title", a.textStr)) : (n = C.createElementNS(Na, "tspan"), I(n, {
                            dy: v,
                            x: i
                        }), q && I(n, "style", q), b.appendChild(n), r > j && (j = r)))) : (n.removeChild(n.firstChild), E.unshift(e.pop())),
                        e.length && n.appendChild(C.createTextNode(e.join(" ").replace(/- /g, "-")))
                    }
                })
            })
        },
        button: function(a, b, c, d, e, f, g, h, i) {
            ...
            n = h.style;
            delete h.style;
            D(k.element, Ha ? "mouseover": "mouseenter",
            function() {
                j !== 3 && k.attr(f).css(p)
            });
            D(k.element, Ha ? "mouseout": "mouseleave",
            function() {
                j !== 3 && (l = [e, f, g][j], m = [o, p, B][j], k.attr(l).css(m))
            });
            k.setState = function(a) { (k.state = j = a) ? a === 2 ? k.attr(g).css(B) : a === 3 && k.attr(h).css(n) : k.attr(e).css(o)
            };
            return k.on("click",
            function() {
                j !== 3 && d.call(k)
        ...
        color: function(a, b, c) {
            ...
            if (g) {
                ...
                for (m in k) o.push(k[m]);
                o = o.join(",");
                h[o] ? a = h[o].id: (c.id = a = "highcharts-" + Ab++, h[o] = i = d.createElement(g).attr(c).add(d.defs), i.stops = [], q(k,
                function(a) {
                ...
                return "url(" + d.url + "#" + a + ")"
            } else return f.test(a) ? (e = Ea(a), I(b, c + "-opacity", e.get("a")), e.get("rgb")) : (b.removeAttribute(c + "-opacity"), a)
        },
        ...
        fontMetrics: function(a) {
            ...
            a = /px/.test(a) ? y(a) : /em/.test(a) ? parseFloat(a) * 12 : 12,
            a = a < 24 ? a + 4 : t(a * 1.2),
            b = t(a * 0.8);
            return {
                h: a,
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            function k() {
                ...
                Fa = K + m.fontMetrics(a && a.fontSize).b;
                if (x) {
                    if (!B) a = t( - z * K),
                    b = h ? -Fa: 0,
                    o.box = B = d ? m.symbol(d, a, b, o.width, o.height, E) : m.rect(a, b, o.width, o.height, 0, E[Tb]),
                    B.attr("fill", X).add(o);
                    B.isImg || B.attr(w({
                        width: o.width,
                        height: o.height
            ...
            function j() {
                ...
                c;
                c = h ? 0 : Fa;
                if (r(cb) && n && (a === "center" || a === "right")) b += {
                    center: 0.5,
                    right: 1
                } [a] * (cb - n.width); (b !== p.x || c !== p.y) && p.attr({
                    x: b,
                    y: c
                });
                p.x = b;
    ...
    u(Ca.prototype, {
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (m !== this.cTT) {
                        ...
                        if (i > l && /[ \-]/.test(b.textContent || b.innerText)) J(b, {
                            width: l + "px",
                            display: "block",
                            whiteSpace: "normal"
                        }),
        ...
        setSpanRotation: function(a, b, c) {
            var d = {},
            e = Ha ? "-ms-transform": mb ? "-webkit-transform": ab ? "MozTransform": Rb ? "-o-transform": "";
    ...
    if (!$ && !ga) Q.VMLElement = pa = {
        ...
        setSpanRotation: function() {
            ...
            c = fa(a * Ma);
            J(this.element, {
                filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c, ", M22=", b, ", sizingMethod='auto expand')"].join("") : X
            })
        },
        ...
        attr: function(a, b) {
            ...
            a[c] = b);
            if (ka(a)) c = a,
            p = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight: this[c];
            else for (c in a) if (d = a[c], m = !1, e = o[c] && o[c].call(this, d, c), e !== !1 && d !== null) {
                e !== s && (d = e);
                if (k && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c)) j || (this.symbolAttr(a), j = !0),
                m = !0;
                else if (c === "d") {
                    d = d || [];
                    this.d = d.join(" ");
                ...
                m = !0;
                else if (ua(c, ["x", "y", "width", "height"]) !== -1) this[c] = d,
                c === "x" || c === "y" ? c = {
                    x: "left",
                    y: "top"
                } [c] : d = v(0, d),
                ...
                this[c] = d,
                za(d) && (d += "px");
                else if (c === "dashstyle")(f.getElementsByTagName("stroke")[0] || Y(i.prepVML(["<stroke/>"]), null, null, f))[c] = d || "solid",
                this.dashstyle = d,
                m = !0;
                else if (c === "fill") if (h === "SPAN") g.color = d;
                else {
                    if (h !== "IMG") f.filled = d !== X ? !0 : !1,
                    d = i.color(d, f, c, this),
                    c = "fillcolor"
                } else if (c === "opacity") m = !0;
                else if (h === "shape" && c === "rotation") this[c] = f.style[c] = d,
                f.style.left = -t(fa(d * Ma) + 1) + "px",
                f.style.top = t(aa(d * Ma)) + "px";
        ...
        shadow: function(a, b, c) {
            ...
            if (a) {
                ...
                for (e = 1; e <= 3; e++) {
                    ...
                    h = Y(g.prepVML(k), null, {
                        left: y(i.left) + n(a.offsetX, 1),
                        top: y(i.top) + n(a.offsetY, 1)
                    });
                    if (c) h.cutOff = l + 1;
    ...
    pa = {
        ...
        color: function(a, b, c, d) {
            ...
            if (i) {
                ...
                o = m.x2 || m[2] || 0,
                m = m.y2 || m[3] || 0,
                K = 'angle="' + (90 - W.atan((m - a) / (o - c)) * 180 / oa) + '"',
                t();
                else {
                    var k = m.r,
                    v = k * 2,
                    ...
                    w = m.cx,
                    E = m.cy,
                    Fa = b.radialReference,
                    x, k = function() {
                        Fa && (x = d.getBBox(), w += (Fa[0] - x.x) / x.width - 0.5, E += (Fa[1] - x.y) / x.height - 0.5, v *= Fa[2] / x.width, u *= Fa[2] / x.height);
                        K = 'src="' + G.global.VMLRadialGradientURL + '" size="' + v + "," + u + '" origin="0.5,0.5" position="' + w + "," + E + '" color2="' + z + '" ';
                        t()
                    };
                    d.added ? k() : d.onAdd = k;
                    k = n
                } else k = j
            } else if (g.test(a) && b.tagName !== "IMG") f = Ea(a),
            h = ["<", c, ' opacity="', f.get("a"), '"/>'],
        ...
        symbols: {
            ...
            rect: function(a, b, c, d, e) {
                var f = a + c,
                g = b + d,
                h; ! r(e) || !e.r ? f = ha.prototype.symbols.square.apply(0, arguments) : (h = x(e.r, c, d), f = ["M", a + h, b, "L", f - h, b, "wa", f - 2 * h, b, f, b + 2 * h, f - h, b, f, b + h, "L", f, g - h, "wa", f - 2 * h, g - 2 * h, f, g, f, g - h, f - h, g, "L", a + h, g, "wa", a, g - 2 * h, a + 2 * h, g, a + h, g, a, g - h, "L", a, b + h, "wa", a, b, a + 2 * h, b + 2 * h, a, b + h, a + h, b, "x", "e"]);
                return f
            }
        }
    },
    ...
    fb.prototype = w(ha.prototype, pa),
    Xa = fb;
    ...
    var Vb;
    if (ga) Q.CanVGRenderer = pa = function() {
        Na = "http://www.w3.org/1999/xhtml"
    },
    pa.prototype.symbols = {},
    Vb = function() {
        function a() {
            var a = b.length,
            d;
    ...
    $a.prototype = {
        addLabel: function() {
            ...
            if (r(e)) e && e.attr({
                ...
                if (za(h.rotation)) l.rotation = h.rotation;
        ...
        getLabelPosition: function(a, b, c, d, e, f, g, h) {
            ...
            o && i.side === 2 && (b -= m - m * aa(o * Ma)); ! r(e.y) && !o && (b += m - c.getBBox().height / 2);
            if (l) c.line = g / (h || 1) % l,
        ...
        render: function(a, b, c) {
            ...
            v = !0,
            u = d.tickmarkOffset,
            w = this.getPosition(g, k, u, b),
            x = w.x,
            w = w.y,
            E = g && x === d.pos + d.len || !g && w === d.pos ? -1 : 1;
            this.isActive = !0;
            if (p) {
            ...
            if (m && z) r === "inside" && (z = -z),
            d.opposite && (z = -z),
            h = this.getMarkPath(x, w, z, m * E, g, f),
            o ? o.animate({
                d: h,
                opacity: c
            ...
            if (i && !isNaN(x)) i.xy = w = this.getLabelPosition(x, w, i, g, j, u, a, t),
            this.isFirst && !this.isLast && !n(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !n(e.showLastLabel, 1) ? v = !1 : !d.isRadial && !j.step && !j.rotation && !b && c !== 0 && (v = this.handleOverflow(a, w)),
            t && a % t && (v = !1),
            v && !isNaN(w.y) ? (w.opacity = c, i[this.isNew ? "attr": "animate"](w), this.isNew = !1) : i.attr("y", -9999)
        },
        destroy: function() {
            Ka(this, this.axis)
        }
    ...
    Q.PlotLineOrBand.prototype = {
        render: function() {
            ...
            if (h) {
                ...
                if (k = v(k, b.min - d), i = x(i, b.max + d), p = b.getPlotBandPath(k, i, e), d = {
                    fill: q
                },
            ...
            } else if (p && p.length && (a.svgElem = o = s.path(p).attr(d).add(), K)) for (B in e = function(b) {
                o.on(b,
                function(c) {
                    K[b].apply(a, [c])
                })
            ...
            if (f && r(f.text) && p && p.length && b.width > 0 && b.height > 0) {
                ...
                f);
                if (!g) a.label = g = s.text(f.text, 0, 0, f.useHTML).attr({
    ...
    N.prototype = {
        ...
        setOptions: function(a) {
            this.options = w(this.defaultOptions, this.isXAxis ? {}: this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], w(G[this.coll], a))
        },
        defaultLabelFormatter: function() {
            ...
            else if (f && a >= 1E3) for (; f--&&g === s;) c = Math.pow(1E3, f + 1),
        ...
        getSeriesExtremes: function() {
            ...
            function(c) {
                if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    a.isLog && d <= 0 && (d = null);
                    if (a.isXAxis) {
                        if (d = c.xData, d.length) a.dataMin = x(n(a.dataMin, d[0]), Sa(d)),
                        a.dataMax = v(n(a.dataMax, d[0]), Aa(d))
                    } else {
                        c.getExtremes();
                        e = c.dataMax;
                        c = c.dataMin;
                        if (r(c) && r(e)) a.dataMin = x(n(a.dataMin, c), c),
                        a.dataMax = v(n(a.dataMax, e), e);
        ...
        adjustForMinRange: function() {
            ...
            f, g, h, i, k;
            if (this.isXAxis && this.minRange === s && !this.isLog) r(a.min) || r(a.max) ? this.minRange = null: (q(this.series,
            function(a) {
                i = a.xData;
        ...
        setAxisTranslation: function(a) {
            ...
            function(a) {
                var h = v(b.isXAxis ? a.pointRange: b.axisPointRange || 0, +i),
                k = a.options.pointPlacement,
                o = a.closestPointRange;
                h > c && (h = 0);
                d = v(d, h);
                f = v(f, ka(k) ? 0 : h / 2);
                g = v(g, k === "on" ? 0 : h); ! a.noSharedTooltip && r(o) && (e = r(e) ? x(e, o) : o)
            }),
        ...
        setTickPositions: function(a) {
            ...
            if (e) ! a && x(b.min, n(b.dataMin, b.min)) <= 0 && na(10, 1),
            b.min = ea(Ga(b.min)),
            b.max = ea(Ga(b.max));
            ...
            b.min === b.max || b.min === void 0 || b.max === void 0 ? b.tickInterval = 1 : h && !l && o === b.linkedParent.options.tickPixelInterval ? b.tickInterval = b.linkedParent.tickInterval: (b.tickInterval = n(l, B ? 1 : (b.max - b.min) * o / v(b.len, o)), !r(l) && b.len < o && !this.isRadial && !this.isLog && !B && d.startOnTick && d.endOnTick && (p = !0, b.tickInterval /= 4));
            g && !a && q(b.series,
            function(a) {
            ...
            if (!a) ! b.ordinalPositions && (b.max - b.min) / b.tickInterval > v(2 * b.len, 200) && na(19, !0),
            ...
            a.length === 1 && (d = O(b.max || 1) * 0.001, b.min -= d, b.max += d)
        },
        ...
        zoom: function(a, b) {
            ...
            d = this.dataMax,
            e = this.options;
            this.allowZoomOutside || (r(c) && a <= x(c, n(e.min, c)) && (a = s), r(d) && b >= v(d, n(e.max, d)) && (b = s));
        ...
        getExtremes: function() {
            var a = this.isLog;
            return {
                min: a ? ea(la(this.min)) : this.min,
                max: a ? ea(la(this.max)) : this.max,
            ...
            if (k || a.isLinked) {
                ...
                if (a.horiz && !a.staggerLines && w && !p.rotation) {
                    for (t = a.reversed ? [].concat(e).reverse() : e; u < w;) {
                        k = [];
                        x = !1;
                        for (p = 0; p < t.length; p++) y = t[p],
                        D = (D = f[y].label && f[y].label.getBBox()) ? D.width: 0,
                        E = p % u,
                        D && (y = a.translate(y), k[E] !== s && y < k[E] && (x = !0), k[E] = y + D);
                        if (x) u++;
                        else break
                    }
                ...
                function(b) {
                    if (h === 0 || h === 2 || {
                        1 : "left",
                        3 : "right"
                    } [h] === a.labelAlign) B = v(f[b].getLabelSize(), B)
                });
                if (a.staggerLines) B *= a.staggerLines,
                a.labelOffset = B
            } else for (t in f) f[t].destroy(),
            delete f[t];
        ...
        render: function() {
            ...
            o = a.alternateBands,
            p = f.stackLabels,
            B = f.alternateGridColor,
            n = a.tickmarkOffset,
            z = f.lineWidth,
            K = d.hasRendered && r(a.oldMin) && !isNaN(a.oldMin),
            t = a.hasData,
            v = a.showAxis,
            u,
            w = f.labels.overflow,
            ...
            if (t || h) if (a.minorTickInterval && !a.categories && q(a.getMinorTickPositions(),
            function(b) {
                m[b] || (m[b] = new $a(a, b, "minor"));
                K && m[b].isNew && m[b].render(null, !0);
                m[b].render(null, !1, 1)
            }), i.length && (k = i.slice(), (b && c || !b && !c) && k.reverse(), x && (k = k.slice(1).concat([k[0]])), q(k,
            function(b, c) {
                x && (c = c === k.length - 1 ? 0 : c + 1);
                if (!h || b >= a.min && b <= a.max) l[b] || (l[b] = new $a(a, b)),
                K && l[b].isNew && l[b].render(c, !0, 0.1),
                l[b].render(c, !1, 1)
            }), n && a.min === 0 && (l[ - 1] || (l[ - 1] = new $a(a, -1, null, !0)), l[ - 1].render( - 1))), B && q(i,
            function(b, c) {
                if (c % 2 === 0 && b < a.max) o[b] || (o[b] = new Q.PlotLineOrBand(a)),
                u = b + n,
                y = i[c + 1] !== s ? i[c + 1] + n: a.max,
                o[b].options = {
                    from: g ? la(u) : u,
                    to: g ? la(y) : y,
                    color: B
            ...
            if (j && v) j[j.isNew ? "attr": "animate"](a.getTitlePosition()),
            j.isNew = !1;
        ...
        drawCrosshair: function(a, b) {
            if (this.crosshair) if ((r(b) || !n(this.crosshair.snap, !0)) === !1) this.hideCrosshair();
            else {
                var c, d = this.crosshair,
                e = d.animation;
                n(d.snap, !0) ? r(b) && (c = this.chart.inverted != this.horiz ? b.plotX: this.len - b.plotY) : c = this.horiz ? a.chartX - this.pos: this.len - a.chartY + this.pos;
    ...
    u(N.prototype, {
        ...
        removePlotBandOrLine: function(a) {
            ...
            function(b) {
                for (e = b.length; e--;) b[e].id === a && ma(b, b[e])
            })
        }
    });
    N.prototype.getTimeTicks = function(a, b, c, d) {
        ...
        if (r(b)) {
            ...
            if (k >= A.minute) i[Mb](k >= A.hour ? 0 : j * T(i[ub]() / j));
            if (k >= A.hour) i[Nb](k >= A.day ? 0 : j * T(i[vb]() / j));
            if (k >= A.day) i[xb](k >= A.month ? 1 : j * T(i[Va]() / j));
            k >= A.month && (i[Ob](k >= A.year ? 0 : j * T(i[jb]() / j)), h = i[kb]());
            k >= A.year && (h -= h % j, i[Pb](h));
            if (k === A.week) i[xb](i[Va]() - i[wb]() + n(d, 1));
            b = 1;
            La && (i = new Date(i.getTime() + La));
            h = i[kb]();
            for (var d = i.getTime(), l = i[jb](), m = i[Va](), o = g ? La: (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;) e.push(d),
            k === A.year ? d = ib(h + b * j, 0) : k === A.month ? d = ib(h, l + b * j) : !g && (k === A.day || k === A.week) ? d = ib(h, l, m + b * j * (k === A.day ? 1 : 7)) : d += k * j,
            b++;
            e.push(d);
            q(Cb(e,
            function(a) {
                return k <= A.hour && a % A.day === o
            }),
            function(a) {
                f[a] = "day"
            })
    ...
    N.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        else if (a >= 0.08) for (var f = T(b), h, i, k, j, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
            i = e.length;
            for (h = 0; h < i && !l; h++) k = Ga(la(f) * e[h]),
            k > b && (!d || j <= c) && g.push(j),
            j > c && (l = !0),
            j = k
        } else if (b = la(b), c = la(c), a = e[d ? "minorTickInterval": "tickInterval"], a = n(a === "auto" ? null: a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length: f) || 1)), a = sb(a, null, rb(a)), g = va(this.getLinearTickPositions(a, b, c), Ga), !d) this._minorAutoInterval = a / 5;
    ...
    Gb.prototype = {
        ...
        getPosition: function(a, b, c) {
            ...
            k = isNaN(c.plotX) ? 0 : c.plotX,
            c = c.plotY,
            d = k + e + (d.inverted ? i: -a - i),
            j = c - b + f + 15,
            l;
            d < 7 && (d = e + v(k, 0) + i);
        ...
        refresh: function(a, b) {
            ...
            h.points = k, a = a[0]) : h = a.getLabelConfig();
            i = i.call(h, this);
            h = a.series;
        ...
        tooltipHeaderFormatter: function(a) {
            ...
            e = c.xDateFormat,
            f = b.xAxis,
            g = f && f.options.type === "datetime" && za(a.key),
            c = c.headerFormat,
    ...
    Ya.prototype = {
        init: function(a, b) {
            ...
            this.pinchDown = [];
            this.lastValidTouch = {};
            if (Q.Tooltip && b.tooltip.enabled) a.tooltip = new Gb(a, b.tooltip);
            this.setDOMEvents()
        },
        ...
        runPointActions: function(a) {
            ...
            if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
                f = [];
                i = c.length;
                for (k = 0; k < i; k++) if (c[k].visible && c[k].options.enableMouseTracking !== !1 && !c[k].noSharedTooltip && c[k].singularTooltips !== !0 && c[k].tooltipPoints.length && (e = c[k].tooltipPoints[l]) && e.series) e._dist = O(l - e.clientX),
                j = x(j, e._dist),
                f.push(e);
            ...
            if (d && !this._onDocumentMouseMove) this._onDocumentMouseMove = function(a) {
                if (r(ja)) da[ja].pointer.onDocumentMouseMove(a)
            },
        ...
        reset: function(a) {
            ...
            d = b.hoverPoint,
            e = b.tooltip,
            f = e && e.shared ? b.hoverPoints: d; (a = a && e && f) && ia(f)[0].plotX === s && (a = !1);
            if (a) e.refresh(f),
            d && d.setState(d.state, !0);
                ...
                if (c) c.onMouseOut();
                e && e.hide();
                if (this._onDocumentMouseMove) S(C, "mousemove", this._onDocumentMouseMove),
            ...
            if (this.selectionMarker) {
                ...
                function(a) {
                    if (a.zoomEnabled) {
                        var b = a.horiz,
                        c = a.toValue(b ? f: g),
                        b = a.toValue(b ? f + e.width: g + e.height); ! isNaN(c) && !isNaN(b) && (d[a.coll].push({
                            axis: a,
                            min: x(c, b),
                            max: v(c, b)
                        }), h = !0)
        ...
        onContainerClick: function(a) {
            ...
            }), P(c.series, "click", u(a, {
                point: c
            })), b.hoverPoint && c.firePointEvent("click", a)) : (u(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && P(b, "click", a))
        },
        setDOMEvents: function() {
            ...
            if (bb) b.ontouchstart = function(b) {
    ...
    u(Q.Pointer.prototype, {
        ...
        pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
            ...
            u = !s && c[1][l],
            w,
            c = function() { ! s && O(t - v) > 20 && (q = h || O(r - u) / O(t - v));
                n = (o - r) / q + t;
                p = i["plot" + (a ? "Width": "Height")] / q
            };
            c();
            b = n;
            b < K.min ? (b = K.min, w = !0) : b + p > K.max && (b = K.max - p, w = !0);
        ...
        pinch: function(a) {
            ...
            k = b.zoomVert || b.pinchVert,
            j = i || k,
            l = b.selectionMarker,
            m = {},
            o = g === 1 && (b.inClass(a.target, "highcharts-tracker") && c.runTrackerClick || c.runChartClick),
            p = {}; (j || e) && !o && a.preventDefault();
            va(f,
            function(a) {
            ...
            function(a) {
                ...
                if (!l) b.selectionMarker = l = u({
                    destroy: ta
                },
                c.plotBox);
                b.pinchTranslate(i, k, d, f, m, l, p, h);
                b.hasPinched = j;
                b.scaleGroups(m, p); ! j && e && g === 1 && this.runPointActions(b.normalize(a))
            }
        },
    ...
    if (U.PointerEvent || U.MSPointerEvent) {
        ...
        Ib = function(a, b, c, d) {
            a = a.originalEvent || a;
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && da[ja]) d(a),
            d = da[ja].pointer,
            d[b]({
                type: c,
        ...
        u(Ya.prototype, {
            onContainerPointerDown: function(a) {
                Ib(a, "onContainerTouchStart", "touchstart",
                function(a) {
                    wa[a.pointerId] = {
                        pageX: a.pageX,
                        pageY: a.pageY,
            ...
            onContainerPointerMove: function(a) {
                Ib(a, "onContainerTouchMove", "touchmove",
                function(a) {
                    wa[a.pointerId] = {
                        pageX: a.pageX,
                        pageY: a.pageY
            ...
            onDocumentPointerUp: function(a) {
                Ib(a, "onContainerTouchEnd", "touchend",
                function(a) {
                    delete wa[a.pointerId]
                })
            },
            batchMSEvents: function(a) {
                a(this.chart.container, Hb ? "pointerdown": "MSPointerDown", this.onContainerPointerDown);
        ...
        R(Ya.prototype, "setDOMEvents",
        function(a) {
            a.apply(this);
            this.batchMSEvents(D)
        });
        R(Ya.prototype, "destroy",
        function(a) {
    ...
    pb.prototype = {
        init: function(a, b) {
            ...
            f = b.itemMarginTop || 0;
            this.options = b;
            if (b.enabled) c.baseline = y(d.fontSize) + 3 + f,
            c.itemStyle = d,
            ...
            c.itemHeight = 0,
            c.lastLineHeight = 0,
            c.symbolWidth = n(b.symbolWidth, 16),
            c.pages = [],
            c.render(),
            D(c.chart, "endResize",
            function() {
        ...
        colorizeItem: function(a, b) {
            ...
            if (f) {
                if (g && f.isMarker) for (k in g = a.convertAttribs(g), g) d = g[k],
                d !== s && (i[k] = d);
                f.attr(i)
            }
        },
        ...
        renderItem: function(a) {
            ...
            a.legendItem = q = c.text(d.labelFormat ? Ja(d.labelFormat, a) : d.labelFormatter.call(a), l ? f + g: -g, this.baseline, r).css(w(a.visible ? h: i)).attr({
                align: l ? "left": "right",
                zIndex: 2
            }).add(a.legendGroup),
            this.setItemEvents && this.setItemEvents(a, q, r, h, i),
            this.colorizeItem(a, a.visible),
            s && this.createCheckboxForItem(a);
            c = q.getBBox();
            f = a.legendItemWidth = d.itemWidth || a.legendItemWidth || f + g + c.width + j + (s ? 20 : 0);
            this.itemHeight = g = t(a.legendItemHeight || c.height);
            if (e && this.itemX - B + f > (m || b.chartWidth - 2 * k - B - d.x)) this.itemX = B,
            this.itemY += p + this.lastLineHeight + o,
        ...
        getAllItems: function() {
            ...
            function(b) {
                var c = b.options;
                if (n(c.showInLegend, !r(c.linkedTo) ? s: !1, !0)) a = a.concat(b.legendItems || (c.legendType === "point" ? b.data: b))
            });
            return a
        },
        render: function() {
        ...
        handleOverflow: function(a) {
            ...
            if (a > f && !e.useHTML) {
                ...
                function(a, b) {
                    ...
                    e = o.length;
                    if (!e || c - o[e - 1] > h && (p || c) !== o[e - 1]) o.push(p || c),
                    e++;
    ...
    F = Q.LegendSymbolMixin = {
        drawRectangle: function(a, b) {
            ...
            b.legendSymbol = this.chart.renderer.rect(0, a.baseline - 5 - c / 2, a.symbolWidth, c, n(a.options.symbolRadius, 2)).attr({
                zIndex: 3
            }).add(b.legendGroup)
        },
        drawLineMarker: function(a) {
            ...
            f = this.legendGroup,
            a = a.baseline - t(e.fontMetrics(a.options.itemStyle.fontSize).b * 0.3),
            g;
            if (b.lineWidth) {
                g = {
    ...
    }; (/Trident\/7\.0/.test(Da) || ab) && R(pb.prototype, "positionItem",
    function(a, b) {
        var c = this,
        d = function() {
    ...
    sa.prototype = {
        ...
        initSeries: function(a) {
            var b = this.options.chart; (b = H[a.type || b.type || b.defaultSeriesType]) || na(17, !0);
            b = new b;
            b.init(this, a);
            return b
        },
        ...
        layOutTitles: function(a) {
            ...
            e), !1, "spacingBox"), !e.floating && !e.verticalAlign && (b = Wa(b + d.getBBox().height)));
        ...
        getChartSize: function() {
            ...
            if (!r(b)) this.containerWidth = nb(c, "width");
            if (!r(a)) this.containerHeight = nb(c, "height");
        ...
        getContainer: function() {
            ...
            e = "highcharts-" + Ab++;
            if (ka(a)) this.renderTo = a = C.getElementById(a);
            a || na(13, !0);
            c = y(I(a, "data-highcharts-chart")); ! isNaN(c) && da[c] && da[c].hasRendered && da[c].destroy();
            I(a, "data-highcharts-chart", this.index);
            a.innerHTML = ""; ! b.skipClone && !a.offsetWidth && this.cloneRenderTo();
            this.getChartSize();
            c = this.chartWidth;
            d = this.chartHeight;
            this.container = a = Y(Ua, {
        ...
        setSize: function(a, b, c) {
            ...
            if (r(a)) d.chartWidth = e = v(0, t(a)),
            d.hasUserSize = !!e;
            if (r(b)) d.chartHeight = f = v(0, t(b)); (Ba ? ob: J)(d.container, {
                width: e + "px",
                height: f + "px"
            },
            Ba);
        ...
        drawChartBox: function() {
            ...
            if (j) f ? f.animate(s) : this.plotBackground = b.rect(p, n, q, z, 0).attr({
                fill: j
            }).add().shadow(a.plotShadow);
            if (l) h ? h.animate(s) : this.plotBGImage = b.image(l, p, n, q, z).add();
            r ? r.animate({
                width: t.width,
                height: t.height
            ...
            if (m) g ? g.animate(g.crisp({
                ...
                width: q,
                height: z
            })) : this.plotBorder = b.rect(p, n, q, z, 0, -m).attr({
        ...
        linkSeries: function() {
            ...
            function(b) {
                ...
                if (ka(d) && (d = d === ":previous" ? a.series[b.index - 1] : a.get(d))) d.linkedSeries.push(b),
                b.linkedParent = d
            })
        },
        ...
        firstRender: function() {
            ...
            if (a.isReadyToRender()) {
                ...
                a.linkSeries();
                P(a, "beforeRender");
                if (Q.Pointer) a.pointer = new Ya(a, b);
                a.render();
                a.renderer.draw();
                c && c.apply(a, [a]);
                q(a.callbacks,
    ...
    xa.prototype = {
        ...
        applyOptions: function(a, b) {
            var c = this.series,
            d = c.pointValKey,
            a = xa.prototype.optionsToObject.call(this, a);
            u(this, a);
        ...
        destroy: function() {
            ...
            if (this.graphic || this.dataLabel) S(this),
    ...
    M.prototype = {
        ...
        bindAxes: function() {
            ...
            function(e) {
                ...
                function(c) {
                    d = c.options;
                    if (b[e] === d.index || b[e] !== s && b[e] === d.id || b[e] === s && d.index === 0) c.series.push(a),
                    a[e] = c,
                    c.isDirty = !0
            ...
            function(a, b) {
                ...
                if (p && h > p) {
                    ...
                    if (za(j)) {
                        ...
                        m += i;
                        e.xIncrement = m
                    } else if (Qa(j)) if (z) for (c = 0; c < h; c++) i = a[c],
                    B[c] = i[0],
                    Oa[c] = i.slice(1, z + 1);
        ...
        processData: function(a) {
            ...
            if (j && this.sorted && (!k || d > k || this.forceCrop)) if (a = h.min, h = h.max, b[d - 1] < a || b[0] > h) b = [],
            c = [];
            ...
            d > 0 && (g === s || d < g) ? g = d: d < 0 && this.requireSorting && na(15);
            this.cropped = f;
            this.cropStart = e;
        ...
        generatePoints: function() {
            ...
            b = this.data = b;
            for (m = 0; m < g; m++) i = h + m,
            k ? l[m] = (new f).init(this, [d[m]].concat(ia(e[m]))) : (b[i] ? j = b[i] : a[i] !== s && (b[i] = j = (new f).init(this, a[i], d[m])), l[m] = j);
        ...
        getExtremes: function(a) {
            ...
            d = a.length;
            for (l = 0; l < d; l++) if (k = c[l], j = a[l], i = j !== null && j !== s && (!b.isLog || j.length || j > 0), k = this.getExtremesFromAll || this.cropped || (c[l + 1] || k) >= g && (c[l - 1] || k) <= h, i && k) if (i = j.length) for (; i--;) j[i] !== null && (e[f++] = j[i]);
            else e[f++] = j;
        ...
        translate: function() {
            ...
            h = !!this.modifyValue,
            i = a.pointPlacement,
            k = i === "between" || za(i), j = a.threshold, a = 0; a < g; a++) {
                var l = f[a],
                m = l.x,
                o = l.y,
                p = l.low,
                q = b && e.stacks[(this.negStacks && o < j ? "-": "") + this.stackKey];
                if (e.isLog && o <= 0) l.y = o = null;
                l.plotX = c.translate(m, 0, 0, 0, 1, i, this.type === "flags");
                if (b && this.visible && q && q[m]) q = q[m],
                o = q.points[this.index],
                p = o[0],
                o = o[1],
                p === 0 && (p = n(j, e.min)),
                e.isLog && p <= 0 && (p = null),
        ...
        animate: function(a) {
            ...
            g = c.inverted,
            h;
            if (e && !ba(e)) e = V[b.type].animation;
            h = "_sharedClip" + e.duration + e.easing;
            if (a) a = c[h],
            e = c[h + "m"],
            a || (c[h] = a = d.clipRect(u(f, {
                width: 0
        ...
        drawPoints: function() {
            ...
            o,
            p = this.markerGroup;
            if (l.enabled || this._hasPointMarkers) for (f = b.length; f--;) if (g = b[f], d = T(g.plotX), e = g.plotY, j = g.graphic, i = g.marker || {},
            a = l.enabled && i.enabled === s || i.enabled, o = c.isInsidePlot(t(d), e, c.inverted), a && e !== s && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select": ""] || m, h = a.r, i = n(i.symbol, this.symbol), k = i.indexOf("url") === 0, j) j.attr({
                visibility: o ? "inherit": "hidden"
            }).animate(u({
                x: d - h,
                y: e - h
            },
            j.symbolName ? {
                ...
                if (o && (h > 0 || k)) g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h).attr(a).add(p)
        ...
        getAttribs: function() {
            ...
            if (!i || g < i || j) for (; g--;) {
                ...
                if (i.options) for (n in l) r(c[l[n]]) && (j = !0);
                if (j) {
                    c = c || {};
                    j = [];
                    d = c.states || {};
                    f = d.hover = d.hover || {};
                    if (!b.marker) f.color = f.color || !i.options.color && e.color || Ea(i.color).brighten(f.brightness || e.brightness).get();
                    f = {
                        color: i.color
                    };
                    if (!p) f.fillColor = i.color;
                    if (!o) f.lineColor = i.color;
    ...
    M.prototype.setStackedPoints = function() {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            ...
            for (n = 0; n < d; n++) {
                ...
                p = (o = k && z < f) ? i: h;
                l[p] || (l[p] = {});
                if (!l[p][q]) m[p] && m[p][q] ? (l[p][q] = m[p][q], l[p][q].total = null) : l[p][q] = new Qb(j, j.options.stackLabels, o, q, g, e);
                p = l[p][q];
    ...
    M.prototype.setPercentStacks = function() {
        ...
        function(b) {
            var e;
            for (var f = d.length,
            g, h; f--;) if (g = d[f], e = (h = c[b] && c[b][g]) && h.points[a.index], g = e) h = h.total ? 100 / h.total: 0,
            g[0] = ea(g[0] * h),
            g[1] = ea(g[1] * h),
    ...
    var qa = ca(M, {
        ...
        getSegments: function() {
            ...
            if (this.options.stacking && !this.cropped) {
                ...
                for (o in f) f[o].total !== null && c.push( + o);
                c.sort(function(a, b) {
                    return a - b
                });
                q(c,
                ...
                b.length && a.push(b)
            } else M.prototype.getSegments.call(this),
            a = this.segments;
            this.segments = a
        },
        getSegmentPath: function(a) {
            ...
            if (e.stacking && !this.closedStacks) for (d = a.length - 1; d >= 0; d--) g = n(a[d].yBottom, f),
        ...
        drawGraph: function() {
            ...
            function(d) {
                ...
                f ? f.animate({
                    ...
                    fill: n(d[2], Ea(d[1]).setOpacity(n(c.fillOpacity, 0.75)).get()),
                    zIndex: 0
                }).add(a.group)
            })
        },
    ...
    ya = ca(M, {
        ...
        getColumnMetrics: function() {
            ...
            function(b) {
                var c = b.options,
                e = b.yAxis;
                if (b.type === a.type && b.visible && d.len === e.len && d.pos === e.pos) c.stacking ? (f = b.stackKey, g[f] === s && (g[f] = i++), h = g[f]) : c.grouping !== !1 && (h = i++),
                b.columnIndex = h
            });
            var c = x(O(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len),
            k = c * b.groupPadding,
            j = (c - 2 * k) / i,
            l = b.pointWidth,
            b = r(l) ? (j - l) / 2 : j * b.pointPadding,
            l = n(l, j - 2 * b);
        ...
        translate: function() {
            ...
            function(a) {
                var b = n(a.yBottom, e),
                c = x(v( - 999 - b, a.plotY), d.len + 999 + b),
                p = a.plotX + i,
                q = h,
                s = x(c, b),
                z,
        ...
        drawPoints: function() {
            ...
            function(f) {
                var g = f.plotY,
                h = f.graphic;
                if (g !== s && !isNaN(g) && f.y !== null) e = f.shapeArgs,
                h ? (eb(h), h[a.points.length < d ? "animate": "attr"](w(e))) : f.graphic = c[f.shapeType](e).attr(f.pointAttr[f.selected ? "select": ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius);
        ...
        animate: function(a) {
            ...
            e = {};
            if ($) a ? (e.scaleY = 0.001, a = x(b.pos + b.len, v(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len: e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX": "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
        },
        remove: function() {
            var a = this,
            b = a.chart;
    ...
    L = {
        ...
        translate: function(a) {
            ...
            k = this.startAngleRad = oa / 180 * (i - 90),
            i = (this.endAngleRad = oa / 180 * (n(c.endAngle, i + 360) - 90)) - k,
            j = this.points,
            ...
            for (m = 0; m < o; m++) {
                ...
                p.angle = h;
                e = x(e, l / 2);
                p.labelPos = [a[0] + f + aa(h) * l, a[1] + g + fa(h) * l, a[0] + f + aa(h) * e, a[1] + g + fa(h) * e, a[0] + f, a[1] + g, l < 0 ? "center": p.half ? "right": "left", h]
            }
        },
        drawGraph: null,
        drawPoints: function() {
            ...
            function(h) {
                ...
                f && f.attr(c);
                d ? d.animate(u(g, c)) : h.graphic = d = b[h.shapeType](g).setRadialReference(a.center).attr(h.pointAttr[h.selected ? "select": ""]).attr({
    ...
    M.prototype.drawDataLabels = function() {
        ...
        h = a.plotGroup("dataLabelsGroup", "data-labels", a.visible ? "visible": "hidden", d.zIndex || 6),
        f = d,
        q(b,
        function(b) {
            var k, j = b.dataLabel,
            ...
            if (j && !k) b.dataLabel = j.destroy();
                ...
                p = !1;
                    ...
                    if (b.dataLabel = j = j.destroy(), o) b.connector = o.destroy()
                } else if (r(g)) {
                    j = {
                    ...
                    j = b.dataLabel = a.chart.renderer[k ? "text": "label"](g, 0, -999, null, null, null, d.useHTML).attr(j).css(u(d.style, c && {
                        cursor: c
    ...
    M.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        i = n(a.plotY, -999),
        k = b.getBBox();
        if (a = this.visible && (a.series.forceDL || f.isInsidePlot(h, t(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g))) d = u({
            x: g ? f.plotWidth - i: h,
        ...
        b[e ? "attr": "animate"](g)) : (b.align(c, null, d), g = b.alignAttr, n(c.overflow, "justify") === "justify" ? this.justifyDataLabel(b, c, g, k, d, e) : n(c.crop, !0) && (a = f.isInsidePlot(g.x, g.y) && f.isInsidePlot(g.x + k.width, g.y + k.height)));
        if (!a) b.attr({
            y: -999
        }),
        b.placed = !1
    ...
    if (H.pie) H.pie.prototype.drawDataLabels = function() {
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (C = 0; ! u && b[C];) u = b[C] && b[C].dataLabel && (b[C].dataLabel.getBBox().height || 21),
            C++;
            for (C = 2; C--;) {
                var b = [],
                I = [],
                ...
                if (l > 0) {
                    for (E = p - o - l; E <= p + o + l; E += u) b.push(E);
                    z = b.length;
                    if (G > z) {
                        c = [].concat(J);
                        c.sort(H);
                        for (E = G; E--;) c[E].rank = E;
                        for (E = G; E--;) J[E].rank >= z && J.splice(E, 1);
                        G = J.length
                    }
                    for (E = 0; E < G; E++) {
                        c = J[E];
                        ...
                        c = 9999;
                        var N, L;
                        for (L = 0; L < z; L++) N = O(b[L] - r[1]),
                        N < c && (c = N, F = L);
                        if (F < E && b[E] !== null) F = E;
                        else for (z < G - E + F && b[E] !== null && (F = z - G + E); b[F] === null;) F++;
                        I.push({
                            i: F,
                            y: b[F]
                        });
                ...
                for (E = 0; E < G; E++) {
                    ...
                    c = r[1];
                    if (l > 0) {
                        if (z = I.pop(), F = z.i, y = z.y, c > y && b[F + 1] !== null || c < y && b[F - 1] !== null) y = c
                    } else y = c;
                    ...
                    s.connX = x;
                    s.connY = y;
                    if (this.options.size === null) z = s.width,
                    x - z < f ? A[3] = v(t(z - x + f), A[3]) : x + z > h - f && (A[1] = v(t(x + z - h + f), A[1])),
                    y - u / 2 < 0 ? A[0] = v(t( - y + u / 2), A[0]) : y + u / 2 > d && (A[2] = v(t(y + u / 2 - d), A[2]))
                }
            }
            if (Aa(A) === 0 || this.verifyDataLabelOverflow(A)) this.placeDataLabels(),
            B && g && q(this.points,
            function(b) {
                i = b.connector;
                r = b.labelPos;
                if ((s = b.dataLabel) && s._pos) D = s._attr.visibility,
                x = s.connX,
                y = s.connY,
                k = j ? ["M", x + (r[6] === "left" ? 5 : -5), y, "C", x, y, 2 * r[2] - r[4], 2 * r[3] - r[5], r[2], r[3], "L", r[4], r[5]] : ["M", x + (r[6] === "left" ? 5 : -5), y, "L", r[2], r[3], "L", r[4], r[5]],
                i ? (i.animate({
                    d: k
                }), i.attr("visibility", D)) : b.connector = i = a.chart.renderer.path(k).attr({
                    "stroke-width": g,
    ...
    H.pie.prototype.alignDataLabel = ta,
    H.pie.prototype.verifyDataLabelOverflow = function(a) {
        var b = this.center,
        c = this.options,
        d = c.center,
        e = c = c.minSize || 80,
    ...
    if (H.column) H.column.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        k = n(c.inside, !!this.options.stacking);
        if (h && (d = w(h), g && (d = {
    ...
    var gb = Q.TrackerMixin = {
        ...
        drawTrackerGraph: function() {
            ...
            function(a) {
                ...
                if (bb) a.on("touchstart", o)
            }))
        }
    };
    if (H.column) ya.prototype.drawTracker = gb.drawTrackerPoint;
    if (H.pie) H.pie.prototype.drawTracker = gb.drawTrackerPoint;
    if (H.scatter) qa.prototype.drawTracker = gb.drawTrackerPoint;
    u(pb.prototype, {
    ...
    u(sa.prototype, {
        ...
        pan: function(a, b) {
            ...
            function(b) {
                ...
                h.series.length && l > x(j.dataMin, j.min) && i < v(j.dataMax, j.max) && (h.setExtremes(l, i, !1, !1, {
                    trigger: "pan"
                }), e = !0);
    ...
    u(xa.prototype, {
        select: function(a, b) {
            ...
            function() {
                ...
                function(a) {
                    ...
                    d.options.data[ua(a, d.data)] = a.options,
                    a.setState(""),
        ...
        onMouseOut: function() {
            var a = this.series.chart,
            b = a.hoverPoints;
            if (!b || ua(this, b) === -1) this.firePointEvent("mouseOut"),
            this.setState(),
            a.hoverPoint = null
        },
        ...
        setState: function(a, b) {
            ...
            if (! (a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (k || h && !i.enabled) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                if (this.graphic) f = g && this.graphic.symbolName && o[a].r,
                this.graphic.attr(w(o[a], f ? {
                    x: c - f,
                    y: d - f,
                    width: 2 * f,
                    height: 2 * f
                    ...
                    if (a && i) if (f = i.radius, l = l.symbol || e.symbol, j && j.currentSymbol !== l && (j = j.destroy()), j) j[b ? "animate": "attr"]({
                        x: c - f,
                        y: d - f
                    });
                    else e.stateMarkerGraphic = j = m.renderer.symbol(l, c - f, d - f, 2 * f, 2 * f).attr(o[a]).add(e.markerGroup),
                    j.currentSymbol = l;
        ...
        setTooltipPoints: function(a) {
            ...
            if (! (this.options.enableMouseTracking === !1 || this.singularTooltips)) {
                ...
                for (i = 0; i < a; i++) if (e = b[i], c = e.x, c >= f.min && c <= f.max) {
                    h = b[i + 1];
                    c = d === s ? 0 : d + 1;
                    for (d = b[i + 1] ? x(v(0, T((e.clientX + (h ? h.wrappedClientX || h.clientX: g)) / 2)), g) : g; c >= 0 && c <= d;) k[c++] = e
                }
    ...
    function(a, b, c, d, e, f, g, h) {
        ...
        m, o, p, n = [],
        q = -Number.MAX_VALUE,
        z = this.options.tickPixelInterval;
        if (!this.options.ordinal || !f || f.length < 3 || c === s) return a.call(this, b, c, d, e);
        ...
        if (h && a.unitRange <= A.hour) {
            k = n.length - 1;
            for (i = 1; i < k; i++)(new Date(n[i] - La))[Va]() !== (new Date(n[i - 1] - La))[Va]() && (l[n[i]] = "day", m = !0);
            m && (l[n[0]] = "day");
            a.higherRanks = l
        }
        n.info = a;
        if (h && r(z)) {
            ...
            m < z * 0.6 && (m = null);
            h = n[a - 1] > d ? a - 1 : a;
            for (t = void 0; h--;) i = k[h],
            d = t - i,
            t && d < z * 0.8 && (m === null || d < m * 0.8) ? (l[n[h]] && !l[n[h + 1]] ? (d = h + 1, t = i) : d = h, n.splice(d, 1)) : t = i
        }
        return n
    });
    u(N.prototype, {
        beforeSetTickPositions: function() {
            ...
            if (this.options.ordinal) {
                ...
                c ? (this.ordinalPositions = b, c = this.val2lin(v(f, b[0]), !0), d = this.val2lin(x(e, b[b.length - 1]), !0), this.ordinalSlope = e = (e - f) / (d - c), this.ordinalOffset = f - c * e) : this.ordinalPositions = this.ordinalSlope = this.ordinalOffset = s
            }
    ...
    function(a, b) {
        ...
        if (c.options.ordinal && c.series.length) {
            ...
            if (m.ordinalPositions) {
                ...
                this.fixedRange = k - i,
                f = c.toFixedRange(null, null, l.apply(j, [o.apply(j, [i, !0]) + f, !0]), l.apply(p, [o.apply(p, [k, !0]) + f, !0])),
                f.min >= x(g.dataMin, i) && f.max <= v(h, k) && c.setExtremes(f.min, f.max, !0, !1, {
                    trigger: "pan"
                }),
                this.mouseDownX = d,
                J(this.container, {
    ...
    hc = Z.generatePoints,
    ic = Z.destroy,
    jc = L.tooltipHeaderFormatter,
    kc = {
        approximation: "average",
        groupPixelWidth: 2,
        dateTimeLabelFormats: Jb("millisecond", ["%A, %b %e, %H:%M:%S.%L", "%A, %b %e, %H:%M:%S.%L", "-%H:%M:%S.%L"], "second", ["%A, %b %e, %H:%M:%S", "%A, %b %e, %H:%M:%S", "-%H:%M:%S"], "minute", ["%A, %b %e, %H:%M", "%A, %b %e, %H:%M", "-%H:%M"], "hour", ["%A, %b %e, %H:%M", "%A, %b %e, %H:%M", "-%H:%M"], "day", ["%A, %b %e, %Y", "%A, %b %e", "-%A, %b %e, %Y"], "week", ["Week from %A, %b %e, %Y", "%A, %b %e", "-%A, %b %e, %Y"], "month", ["%B %Y", "%B", "-%B %Y"], "year", ["%Y", "%Y", "-%Y"])
    },
    Wb = {
        line: {},
        spline: {},
    ...
    Z.groupData = function(a, b, c, d) {
        ...
        for (; n <= i; n++) {
            for (; c[1] !== s && a[n] >= c[1] || n === i;) if (k = c.shift(), j = d.apply(0, m), j !== s && (g.push(k), h.push(j)), m[0] = [], m[1] = [], m[2] = [], m[3] = [], n === i) break;
            if (n === i) break;
            if (o) {
                k = this.cropStart + n;
                ...
                [f[k]]);
                var q;
                for (j = 0; j < p; j++) if (q = k[o[j]], typeof q === "number") m[j].push(q);
                else if (q === null) m[j].hasNulls = !0
            } else if (k = l ? b[n] : null, typeof k === "number") m[0].push(k);
    ...
    Z.processData = function() {
        ...
        if (gc.apply(this, arguments) !== !1 && d) {
            ...
            if (k) {
                ...
                g = Z.groupData.apply(this, [f, g, k, c.approximation]),
                f = g[0],
                g = g[1];
                if (c.smoothed) {
                    c = f.length - 1;
                ...
                if (r(f[0]) && f[0] < a.dataMin) a.dataMin = f[0];
    ...
    L.tooltipHeaderFormatter = function(a) {
        ...
        if (g && g.options.type === "datetime" && d && za(a.key)) {
            ...
            else if (!e && d) for (h in A) if (A[h] >= g.closestPointRange || A[h] <= A.day && a.key % A[h] > 0) {
                e = d[h][0];
                break
            }
            e = ra(e, a.key);
    ...
    function(a, b) {
        ...
        f = V[d].dataGrouping;
        if (Wb[d]) f || (f = w(kc, Wb[d])),
        c.dataGrouping = w(f, e.series && e.series.dataGrouping, e[d].dataGrouping, b.dataGrouping);
        if (this.chart.options._stock) this.requireSorting = !0;
        return c
    });
    R(N.prototype, "setScale",
    function(a) {
        a.call(this);
        q(this.series,
        function(a) {
    ...
    V.ohlc = w(V.column, {
        lineWidth: 1,
        tooltip: {
            pointFormat: '<span style="color:{series.color};font-weight:bold">{series.name}</span><br/>开盘: {point.open}<br/>最高价: {point.high}<br/>最低价: {point.low}<br/>闭盘: {point.close}<br/>'
        },
        states: {
            hover: {
                lineWidth: 3
    ...
    L = ca(H.column, {
        ...
        drawPoints: function() {
            ...
            q(a.points,
            function(j) {
                if (j.plotY !== s) i = j.graphic,
                c = j.pointAttr[j.selected ? "selected": ""],
                f = c["stroke-width"] % 2 / 2,
                k = t(j.plotX) - f,
                g = t(j.shapeArgs.width / 2),
                h = ["M", k, t(j.yBottom), "L", k, t(j.plotY)],
                j.open !== null && (d = t(j.plotOpen) + f, h.push("M", k, d, "L", k - g, d)),
                j.close !== null && (e = t(j.plotClose) + f, h.push("M", k, e, "L", k + g, e)),
                i ? i.animate({
                    d: h
    ...
    L = ca(L, {
        ...
        drawPoints: function() {
            ...
            function(n) {
                m = n.graphic;
                if (n.plotY !== s) c = n.pointAttr[n.selected ? "selected": ""] || d,
                ...
                g = W.min(e, f),
                h = W.max(e, f),
                p = t(n.shapeArgs.width / 2),
                i = t(g) !== t(n.plotY),
                k = h !== n.yBottom,
                g = t(g) + j,
                h = t(h) + j,
                o = ["M", l - p, h, "L", l - p, g, "L", l + p, g, "L", l + p, h, "Z", "M", l, g, "L", l, i ? t(n.plotY) : g, "M", l, h, "L", l, k ? t(n.yBottom) : h, "Z"],
                m ? m.animate({
                    d: o
    ...
    H.flags = ca(H.column, {
        ...
        translate: function() {
            ...
            if (d && d.visible && h) {
                ...
                for (b.sort(function(a, b) {
                    ...
                    j.x < d.x && !f && (m = g[h + 1]) && m.plotY !== s && (d.plotY += (d.x - j.x) / (m.x - j.x) * (m.plotY - j.plotY));
                    c--;
                    h++;
                    if (c < 0) break
                }
            ...
            q(b,
            function(c, d) {
                if (c.plotY === s) c.x >= k.min && c.x <= k.max ? c.plotY = a.chartHeight - i.bottom - (i.opposite ? i.height: 0) + i.offset - a.plotTop: c.shapeArgs = {};
        ...
        drawPoints: function() {
            ...
            o,
            n;
            for (k = c.length; k--;) if (j = c[k], a = j.plotX > this.xAxis.len, e = j.plotX + (a ? m: -m), l = j.stackIndex, i = j.options.shape || g.shape, f = j.plotY, f !== s && (f = j.plotY + h + m - (l !== s && l * g.stackDistance)), o = l ? s: j.plotX + m, n = l ? s: j.plotY, l = j.graphic, f !== s && e >= 0 && !a) a = j.pointAttr[j.selected ? "select": ""] || b,
            l ? l.attr({
                x: e,
                y: f,
                r: a.r,
                anchorX: o,
                anchorY: n
            }) : j.graphic = d.label(j.options.title || g.title || "A", e, f, i, o, n, g.useHTML).css(w(g.style, j.style)).attr(a).attr({
    ...
    Xa === Q.VMLRenderer && q(["flag", "circlepin", "squarepin"],
    function(a) {
    ...
    u(G, {
        navigator: {
            ...
            outlineWidth: 1,
            series: {
                type: H.areaspline === s ? "line": "areaspline",
                color: "#4572A7",
                compare: null,
                fillOpacity: 0.4,
                dataGrouping: {
    ...
    yb.prototype = {
        ...
        render: function(a, b, c, d) {
            ...
            I;
            if (!isNaN(a)) {
                this.navigatorLeft = g = n(l.left, e.plotLeft + p);
                ...
                if (! (l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    a = c - b;
                    if (!this.rendered) {
                        if (C) this.navigatorGroup = l = f.g("navigator").attr({
                            zIndex: 3
                        }).add(),
                    ...
                    C && (this.leftShade[e]({
                        ...
                        d: ["M", i, G, "L", g + b + A, G, g + b + A, G + E - p, "M", g + c - A, G + E - p, "L", g + c - A, G, i + k, G]
                    }), this.drawHandle(b + A, 0), this.drawHandle(c + A, 1));
                    ...
                    this.scrollbarRifles.attr({
                        ...
                        d: ["M", u - 3, p / 4, "L", u - 3, 2 * p / 3, "M", u, p / 4, "L", u, 2 * p / 3, "M", u + 3, p / 4, "L", u + 3, 2 * p / 3]
                    });
                    this.scrollbarPad = F;
                    this.rendered = !0
                }
        ...
        init: function() {
            ...
            a.mouseDownHandler = function(d) {
                ...
                u,
                v = db ? 10 : 7;
                if (t > h && t < h + g + k) if ((h = !a.scrollbarEnabled || t < h + g) && W.abs(r - e - n) < v) a.grabbedLeft = !0,
                a.otherHandlePos = f,
                a.fixedExtreme = d.max,
                b.fixedRange = null;
                else if (h && W.abs(r - f - n) < v) a.grabbedRight = !0,
                a.otherHandlePos = e,
                ...
                b.fixedRange = null;
                    ...
                    u = c.dataMax;
                    if (f !== e) a.fixedWidth = s,
                    e = c.toFixedRange(f, f + s, null, u),
            ...
            var o = b.xAxis.length,
            p = b.yAxis.length;
            b.extraBottomMargin = a.outlineHeight + f.margin;
            a.navigatorEnabled ? (a.xAxis = c = new N(b, w({
            ...
            f.xAxis, {
                ...
                index: p,
                zoomEnabled: !1
            })), m || f.series.data ? a.addBaseSeries() : b.series.length === 0 && R(b, "redraw",
            function(c, d) {
        ...
        getUnionExtremes: function(a) {
            ...
            if (!a || b.dataMin !== null) return {
                dataMin: n(d && d.min, (r(b.dataMin) && r(c.dataMin) ? x: n)(b.dataMin, c.dataMin)),
                dataMax: n(d && d.max, (r(b.dataMax) && r(c.dataMax) ? v: n)(b.dataMax, c.dataMax))
            }
        },
        ...
        addBaseSeries: function() {
            ...
            a.userOptions.events = u(a.userOptions.event, {
        ...
        updatedDataHandler: function() {
            ...
            n && (i || k) ? isNaN(l) || c.setExtremes(l, j, !0, !1, {
                trigger: "updatedData"
            }) : (m && this.chart.redraw(!1), a.render(v(e, g), x(f, d)))
        },
        destroy: function() {
            this.removeEvents();
    ...
    function(a, b, c) {
        ...
        r(b) ? this.previousZoom = [this.min, this.max] : d && (b = d[0], c = d[1], delete this.previousZoom);
    ...
    zb.prototype = {
        clickButton: function(a, b) {
            ...
            if (! (k === null || j === null || a === c.selected)) {
                ...
                o["set" + l](o["get" + l]() - r),
                l = o.getTime(),
                k = n(k, Number.MIN_VALUE),
                isNaN(l) || l < k ? (l = k, m = x(l + i, j)) : i = m - l;
                else if (i) l = v(m - i, k),
                m = x(l + i, j);
                else if (p === "ytd") if (h) {
                    if (j === s) k = Number.MAX_VALUE,
                    j = Number.MIN_VALUE,
                    q(e.series,
                    function(a) {
                        a = a.xData;
                ...
                f[a] && f[a].setState(2);
                e.fixedRange = i;
                h ? h.setExtremes(l, m, n(b, 1), 0, {
                    trigger: "rangeSelectorButton",
                    rangeSelectorButton: g
                }) : (d = e.options.xAxis, d[0] = w(d[0], {
                    range: i,
                    min: u
                }));
                c.setSelected(a)
        ...
        setInputValue: function(a, b) {
            ...
            this[a + "Input"].value = ra(c.inputEditDateFormat || "%Y-%m-%d", this[a + "Input"].HCTime);
            this[a + "DateBox"].attr({
                text: ra(c.inputDateFormat || "%b %e, %Y", this[a + "Input"].HCTime)
            })
        },
        drawInput: function(a) {
            ...
            this[a + "Label"] = k = e.label(G.lang[h ? "rangeSelectorFrom": "rangeSelectorTo"], this.inputGroup.offset).attr({
                padding: 1
            }).css(w(d, f.labelStyle)).add(l);
            l.offset += k.width + 5;
            ...
            i.onchange = function() {
                ...
                isNaN(d) || (G.global.useUTC || (d += (new Date).getTimezoneOffset() * 6E4), h ? d > b.maxInput.HCTime ? d = s: d < g && (d = g) : d < b.minInput.HCTime ? d = s: d > j && (d = j), d !== s && c.xAxis[0].setExtremes(h ? d: e.min, h ? e.max: d, s, s, {
        ...
        render: function(a, b) {
            ...
            function(a, b) {
                k[b] = e.button(a.text, r, d.plotTop - 25,
                function() {
                    c.clickButton(b);
                    c.isActive = !0
                },
            ...
            }), c.updateButtonStates(), m)) c.div = j = Y("div", null, {
                position: "relative",
                height: 0,
                zIndex: 1
            }),
    ...
    N.prototype.toFixedRange = function(a, b, c, d) {
    ...
    sa.prototype.callbacks.push(function(a) {
        ...
        var f, g = a.scroller,
        h = a.rangeSelector;
        g && (D(a.xAxis[0], "afterSetExtremes", d), R(a, "drawChartBox",
        function(a) {
    ...
    Q.StockChart = function(a, b) {
        var c = a.series,
        d, e = n(a.navigator && a.navigator.enabled, !0) ? {
            startOnTick: !1,
            endOnTick: !1
        }: null,
        f = {
    ...
    N.prototype.getPlotLinePath = function(a, b, c, d, e) {
        var f = this,
        g = this.isLinked ? this.linkedParent.series: this.series,
        h = f.chart.renderer,
        i = f.left,
        k = f.top,
        j,
        ...
        o,
        p = [],
        g = this.isXAxis ? r(this.options.yAxis) ? [this.chart.yAxis[this.options.yAxis]] : va(g,
        function(a) {
            return a.yAxis
        }) : r(this.options.xAxis) ? [this.chart.xAxis[this.options.xAxis]] : va(g,
        function(a) {
            return a.xAxis
        }),
        s = [];
        ...
        function(a) {
            l = a.top;
            o = l + a.len;
            j = m = t(e + f.transB); (j >= i && j <= i + f.width || d) && p.push("M", j, l, "L", m, o)
        }) : q(s,
        function(a) {
            j = a.left;
            m = j + a.width;
            l = o = t(k + f.height - e); (l >= k && l <= k + f.height || d) && p.push("M", j, l, "L", m, o)
        }));
        return p.length > 0 ? h.crispPolyLine(p, b || 1) : null
    };
    ha.prototype.crispPolyLine = function(a, b) {
        var c;
        for (c = 0; c < a.length; c += 6) a[c + 1] === a[c + 4] && (a[c + 1] = a[c + 4] = t(a[c + 1]) - b % 2 / 2),
        a[c + 2] === a[c + 5] && (a[c + 2] = a[c + 5] = t(a[c + 2]) + b % 2 / 2);
        return a
    };
    if (Xa === Q.VMLRenderer) fb.prototype.crispPolyLine = ha.prototype.crispPolyLine;
    R(N.prototype, "hideCrosshair",
    function(a, b) {
        a.call(this, b);
        r(this.crossLabelArray) && (r(b) ? this.crossLabelArray[b] && this.crossLabelArray[b].hide() : q(this.crossLabelArray,
        function(a) {
            a.hide()
        }))
    });
    R(N.prototype, "drawCrosshair",
    function(a, b, c) {
        var d, e;
        a.call(this, b, c);
        if (r(this.crosshair.label) && this.crosshair.label.enabled && r(c)) {
            ...
            else { ! o && !f.formatter && (this.isDatetimeAxis && (p = "%b %d, %Y"), o = "{value" + (p ? ":" + p: "") + "}");
                j.attr({
                    x: l,
                    y: m,
                    text: o ? Ja(o, {
    ...
    var lc = Z.init,
    mc = Z.processData,
    nc = xa.prototype.tooltipFormatter;
    Z.init = function() {
